...
@section('content')
    ...
    <form action="/groups" method="POST">
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control is-valid" id="name" name="name" aria-describedby="name" value="{{ old('name') }}" required>
            @error('name')
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control is-invalid" id="description" name="description" aria-describedby="description" value="{{ old('description') }}" required>
            @error('description')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
